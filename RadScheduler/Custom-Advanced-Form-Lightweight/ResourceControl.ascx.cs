...
public partial class RadSchedulerAdvancedFormResourceControl : System.Web.UI.UserControl 
{
    ...
    private void PopulateResources()
    {
        ...
        {
            ResourceValue.Items.Add(new DropDownListItem(res.Text, SerializeResourceKey(res.Key)));
        }
    }
    ...
    {
        ResourceValue.Items.Insert(0, new DropDownListItem("-", "NULL"));
    ...
    {
        return LosSerializer.Deserialize(key);
    }
}
