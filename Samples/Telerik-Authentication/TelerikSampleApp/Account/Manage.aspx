<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="TelerikSampleApp.Account.Manage" %>
                ...
                <asp:PlaceHolder runat="server" ID="setPassword" Visible="false">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <telerik:RadTextBox runat="server" ID="password" TextMode="Password" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <telerik:RadTextBox runat="server" ID="confirmPassword" TextMode="Password"  />
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <telerik:RadTextBox runat="server" ID="CurrentPassword" TextMode="Password"  />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <telerik:RadTextBox runat="server" ID="NewPassword" TextMode="Password" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                 <telerik:RadTextBox runat="server" ID="ConfirmNewPassword" TextMode="Password" />
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <telerik:RadButton runat="server" Text="Change Password" ValidationGroup="ChangePassword" OnClick="ChangePassword_Click" />
                            </div>
                        </div>
                    </div>
                </asp:PlaceHolder>
                ...
                <asp:ListView runat="server"
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <telerik:RadButton runat="server" Text="Remove" CommandName="Delete" CausesValidation="false"
