<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MultipleValuesResourceControl.ascx.cs" Inherits="RadSchedulerAdvancedFormMultipleValuesResourceControl" %>
...
<asp:Label runat="server" ID="ResourceLabel" AssociatedControlID="ResourceValuesPlaceHolder" Text='<%# Label %>' CssClass="rfbLabel" />
